...
CREATE TABLE student_profiles (
    ...
    placed_package VARCHAR(50) DEFAULT NULL,
    placement_field VARCHAR(100) DEFAULT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE academician_profiles (
    ...
    state VARCHAR(100) DEFAULT NULL,
    pincode VARCHAR(20) DEFAULT NULL,
    is_open_guest_lecture TINYINT(1) DEFAULT 0,
    guest_lecture_topics TEXT DEFAULT NULL,
    guest_lecture_mode VARCHAR(50) DEFAULT 'VIRTUAL',
    guest_lecture_bio TEXT DEFAULT NULL,
    guest_lecture_experience VARCHAR(100) DEFAULT NULL,
